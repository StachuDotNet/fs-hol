...
// 
// System.Double.Parse - converts a string argument into a numerical value.
//
// The following function will convert a comma separated string into an array of the column values.
//                       
